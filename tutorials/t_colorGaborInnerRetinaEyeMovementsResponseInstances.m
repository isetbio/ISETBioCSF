function validationData = t_colorGaborInnerRetinaEyeMovementsResponseInstances(varargin)
...
if (p.Results.compute)
    ...
    [responseInstanceArray,noiseFreeIsomerizations] = colorDetectResponseInstanceArrayInnerRetinaFastConstruct(stimulusLabel, testDirectionParams.trialsNum, rParams.temporalParams.simulationTimeStepSecs, ...
    ...
    for kk = 1:nParforConditions
        ...
        colorModulationParamsTemp.contrast = .999;%thisConditionStruct.contrast;
