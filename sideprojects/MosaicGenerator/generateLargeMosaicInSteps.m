function generateLargeMosaicInSteps
    mosaicFOV = 10.0;
    visualizationUpdateIterations = 10;
    ...
    mosaicParams = struct(...
        ...
        'latticeAdjustmentPositionalToleranceF', 0.005, ...
        'latticeAdjustmentDelaunayToleranceF', 0.0005, ...
    ...
    mosaicFileName = sprintf('ConeMosaic_%2.1fDegs', mosaicFOV);
    save(mosaicFileName, 'theMosaic');
    fprintf('Mosaic saved in ''%s''.', mosaicFileName);
