function visualizeSpatialPoolingKernelsAndStimuli(spatialPoolingKernels, ...
    ...
    visualizeSpatialPoolingScheme(ax1, ax2, ax3, spatialPoolingKernels.coneLocsDegs, spatialPoolingKernels.coneAperture, ...
        ...
        sprintf('low frequency, C=%2.2f%% (0 deg)', contrastLevelForScene));
    ...
    visualizeSpatialPoolingScheme(ax1, ax2, ax3, spatialPoolingKernels.coneLocsDegs, spatialPoolingKernels.coneAperture, ...
        ...
        spatialSupportDegs, sceneRGB, ...
        sprintf('low frequency, C=%2.2f%% (90 deg)', contrastLevelForScene));
    ...
    visualizeSpatialPoolingScheme(ax1, ax2, ax3, spatialPoolingKernels.coneLocsDegs, spatialPoolingKernels.coneAperture, ...
        ...
        spatialSupportDegs, sceneRGB, ...
        sprintf('high frequency, C=%2.2f%% (0 deg)', contrastLevelForScene));
    ...
    visualizeSpatialPoolingScheme(ax1, ax2, ax3, spatialPoolingKernels.coneLocsDegs, spatialPoolingKernels.coneAperture, ...
        ...
        spatialSupportDegs, sceneRGB, ...
        sprintf('high frequency, C=%2.2f%% (90 deg)', contrastLevelForScene));
