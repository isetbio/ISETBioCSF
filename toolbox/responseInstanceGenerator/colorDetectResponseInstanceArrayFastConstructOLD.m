function [responseInstanceArray,noiseFreeIsomerizations] = colorDetectResponseInstanceArrayFastConstructOLD(stimulusLabel, nTrials, simulationTimeStep, spatialParams, backgroundParams, colorModulationParams, temporalParams, theOI, theMosaic)
% [responseInstanceArray,noiseFreeIsomerizations] = colorDetectResponseInstanceArrayFastConstructOLD(stimulusLabel, nTrials, simulationTimeStep, spatialParams, backgroundParams, colorModulationParams, temporalParams, theOI, theMosaic)
% 
