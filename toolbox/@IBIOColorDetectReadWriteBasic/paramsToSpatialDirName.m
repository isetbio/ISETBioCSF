...
switch (spatialParams.spatialType)
    case 'Gabor'
        ...
        dirname = sprintf('[STIM_SPATIAL]_SFcpd%0.2f_phase%0.2f_FOVdegs%0.1f_%s',...
            spatialParams.cyclesPerDegree,...
            spatialParams.ph,....
            spatialParams.fieldOfViewDegs,...
            windowStr);
    case 'spot'
        dirname = sprintf('[STIM_SPATIAL]_spotSideDegs%0.3f_backgroundSizeDegs%0.1f_fielfOfViewDegs%0.1f',...
