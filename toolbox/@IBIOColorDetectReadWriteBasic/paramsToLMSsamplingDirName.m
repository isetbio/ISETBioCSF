...
dirname = sprintf('[LMS_SPACE_SAMPLING]_azimuth%2.0f_elevation%2.0f_stimStrengthAxis_%0.5f_%0.5f_%0.0f_instancesBlocks%0.0f_instancesBlockSize',...
                params.azimuthAngle, ...
                params.elevationAngle, ...
                params.stimulusStrengthAxis(1), ...
                params.stimulusStrengthAxis(end), ...
                numel(params.stimulusStrengthAxis), ...
                params.instancesBlocksNum, ...
                params.instancesBlockSize ...
                );
end
