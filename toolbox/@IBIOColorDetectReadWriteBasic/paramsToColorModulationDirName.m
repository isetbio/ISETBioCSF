...
switch (params.modulationType)
    case 'monitor'
        dirname = sprintf('CM]_L%0.0f_M%0.0f_S%0.0f_con%0.5f_wls_%d_%d_%d',...
            ...
            params.endWl);
    case 'AO'
        dirname = sprintf('SM_%d_%0.1f_con%0.5f_wls_%d_%d_%d',params.spotWavelengthNm,params.spotCornealPowerUW,100*params.contrast,...
            params.startWl,...
            params.deltaWl,...
            params.endWl);
    otherwise
