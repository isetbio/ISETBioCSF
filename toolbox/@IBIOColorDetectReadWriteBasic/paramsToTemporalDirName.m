...
dirname = sprintf('[STIM_TEMPORAL]_rampDurationMilliSecs%0.0f_stimDurMilliSecs%0.0f_analyzedResponseDurationMilliSecs%0.0f_withOffsetMilliSecs%0.0f_eyeMovementPath%s',...
