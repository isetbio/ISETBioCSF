...
dirname = sprintf('[MOSAIC]_%sPacking_coneSizeMicrons%0.4f_coneSepMicrons%0.4f_rotationDegs%d_eccentricityDegs%0.2f_LMSdensities%0.2f_%0.2f_%0.2f_FOVdegs%0.2fx%0.2f_intTimeMilliSecs%0.0f_photonNoise%s_osModel%s_osTimeStepMilliSecs%0.2f_osNoise%s_apBlur%d_dark_%d_%d_%d',...
    mosaicParams.conePacking, mosaicParams.innerSegmentSizeMicrons, mosaicParams.coneSpacingMicrons, mosaicParams.mosaicRotationDegs,mosaicParams.eccentricityDegs, ...
