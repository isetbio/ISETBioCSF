...
dirname = sprintf('[MOSAIC]_%sPacking_coneSizeMicrons%0.4f_coneSepMicrons%0.4f_ecc%0.1f_LMSdensities%0.2f_%0.2f_%0.2f_FOVdegs%0.1fx%0.1f_intTimeMilliSecs%0.0f_photonNoise%s_osModel%s_osTimeStepMilliSecs%0.2f_osNoise%s_apBlur%d',...
    mosaicParams.conePacking, mosaicParams.innerSegmentSizeMicrons, mosaicParams.coneSpacingMicrons, mosaicParams.eccentricityDegs, ...
