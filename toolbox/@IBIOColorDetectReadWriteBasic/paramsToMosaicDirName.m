...
%   242 for docker (aufs)
dirname = sprintf('[MOSAIC]_%sPacking_coneSize_um%0.4f_coneSep_um%0.4f_rotationDegs%d_eccentricityDegs%0.2f_LMSdensities%0.2f_%0.2f_%0.2f_FOVdegs%0.2fx%0.2f_intTime_ms%0.0f_photonNoise%s_osModel%s_osTimeStep_ms%0.2f_osNoise%s_apBlur%d_dark_%d_%d_%d',...
