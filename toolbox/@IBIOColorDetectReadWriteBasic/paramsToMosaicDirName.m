...
dirname = sprintf('[MOSAIC]_type%s_ecc%0.1f_LMSdensities%0.2f_%0.2f_%0.2f_FOVdegs%0.1fx%0.1f_intTime%0.1f_osTime%0.2f_pNoise%d_osNoise%d_eyeMvmnts%d',...
    mosaicParams.mosaicType, mosaicParams.eccentricityDegs, ...
