function hFig = visualizeResponsesInstancesAndNoiseFreeResponsesAsDensityPlots(timeAxis, noStimResponseInstances, stimResponseInstances, noStimNoiseFreeResponse, stimNoiseFreeResponse, responseRange, responseLevelsNum, plotType, yAxisLabel, figNo)
