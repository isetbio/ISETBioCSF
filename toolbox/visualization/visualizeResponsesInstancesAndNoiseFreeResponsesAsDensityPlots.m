function hFig = visualizeResponsesInstancesAndNoiseFreeResponsesAsDensityPlots(timeAxis, noStimResponseInstances, stimResponseInstances, noStimNoiseFreeResponse, stimNoiseFreeResponse,  p, responseLevelsNum, plotType, yAxisLabel, figNo)
