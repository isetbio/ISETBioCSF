function run_paper2_CrowellBanksUnpublishedExperimentTest
...
%    09/20/19  npc  Wrote it.
    ...
    % Cycles/deg examined
    cyclesPerDegreeExamined = [14]; % [2.5 5 14 28];    % Crowell & Banks employed 1.75, 5, 14, and 28 c/deg.
    ...
    nTrainingSamples = 512/4;                            % 1032 to signify the Crowell & Banks runs
