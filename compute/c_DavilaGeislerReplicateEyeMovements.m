...
%% Modify the default params based on the user-passed params in varargin
userParams = modifyDefaultsBasedOnUserParams(varargin{:});
...
%% modifyDefaultsBasedOnUserParams
function userParams = modifyDefaultsBasedOnUserParams(paramsList)
...
%   'freezeNoise' - true/false (default true). Freeze noise so calculations reproduce.
    ...
    p.addParameter('resamplingFactor', 6, @isnumeric); 
    ...
    % default spatialPoolingKernel for use with 'svmGaussianRF' and 'mlptGaussianRF' treshold methods
