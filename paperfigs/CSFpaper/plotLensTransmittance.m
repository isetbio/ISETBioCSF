function plotLensAndMacularPigmentTransmittance
    ...
    export = struct(...
        'format','PDF', ...
        'name', fullfile(localDir, 'LensTransmittance.pdf') ...
        );
    renderXYplot(lambda,lensTransmittance,  xLims, yLims, xTicks, yTicks, 'wavelength (nm)', 'transmittance', export);
end

function renderXYplot(lambda,lensTransmittance, xLims, yLims, xTicks, yTicks, xLabel, yLabel, export)
    % Render figure
    hFig = figure(1); clf;
