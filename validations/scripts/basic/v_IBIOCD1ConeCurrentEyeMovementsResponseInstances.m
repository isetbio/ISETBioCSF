...
function ValidationFunction(runTimeParams)
    ...
    %% Basic validation
    [validationData1, extraData1] = t_coneCurrentEyeMovementsResponseInstances('generatePlots',runTimeParams.generatePlots, 'setRng', true);
    UnitTest.validationData('validationData1',validationData1);
    UnitTest.extraData('extraData1',extraData1);
     
    %% Spot version
    [validationData2, extraData2] = t_coneCurrentEyeMovementsResponseInstancesSpot('generatePlots',runTimeParams.generatePlots, 'setRng', true);
